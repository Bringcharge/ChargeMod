...
public class InstructionsManager {
    ...
    public static Vec3 vecWithString(Instruction instruction, InstructionsModel owner) { //返还Vec3d的方法
    ...
    public static String instructionsBlock (Instruction instruction, InstructionsModel owner) { //非自动机部分，用于处理代码块
        String order = null;
        int stackCount = 0;
