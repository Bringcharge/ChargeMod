...
public class BooleanInstruction {
    public static boolean parser(Instruction instruction, InstructionsModel owner) {    //输入
        ...
        if (order != null && order.equals("B011_")) {   //判断两个double是否相等
