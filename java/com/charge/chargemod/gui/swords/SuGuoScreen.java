...
public class SuGuoScreen extends ChargeBaseScreen {
    ...
    public SuGuoScreen() {
        ...
        bottomItem = Items.CLOCK;
        bottomRightItem = Items.GLASS;
        rightItem = Items.SAND;
        topRightItem = Items.APPLE;
        bottomLeftItem = Items.CACTUS;
        leftItem = Items.CLAY;
        topLeftItem = Items.GOLD_ORE;
        topItem = Items.NETHER_BRICK_SLAB;
        rightStringLocal = "使用时钟，玻璃，沙子，苹果，仙人掌，粘土块，金矿石，地狱砖台阶合成，因果本身太过强大，以灵力仅能微弱的撬动它，威力并不会过于强大。";
    }
