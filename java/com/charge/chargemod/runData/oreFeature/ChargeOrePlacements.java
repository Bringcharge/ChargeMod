...
//矿物的生成条件和位置
public class ChargeOrePlacements {
    public static final ResourceKey<PlacedFeature> LING_SHI_ORE = createKey("ling_shi_ore.json");
    ...
    public static void bootstrap(BootstapContext<PlacedFeature> pContext) {
        ...
        Holder<ConfiguredFeature<?, ?>> oreRubyHolder = holdergetter.getOrThrow(ChargeOreFeatures.LING_SHI);
        ...
        PlacementUtils.register(
                pContext, LING_SHI_ORE, oreRubyHolder, commonOrePlacement(16, HeightRangePlacement.uniform(VerticalAnchor.absolute(0), VerticalAnchor.absolute(72)))
        );
    }
    ...
    public static ResourceKey<PlacedFeature> createKey(String pKey) {
        return ResourceKey.create(Registries.PLACED_FEATURE, new ResourceLocation(ChargeModItemRegistry.MODID,pKey));
    }
