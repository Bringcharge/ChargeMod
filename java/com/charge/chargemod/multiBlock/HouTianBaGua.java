...
public class HouTianBaGua implements ChargeMultiBlockCheck {
    ...
    public HouTianBaGua() {
        List<Vec3i> baseBlocks = List.of(
                ...
                new Vec3i(10,-1,4),
                new Vec3i(10,-1,2),
                new Vec3i(10,-1,0), //第十行
                new Vec3i(11,-1,24),
                new Vec3i(11,-1,22),
                new Vec3i(11,-1,20),
                new Vec3i(11,-1,4),
                new Vec3i(11,-1,2),
                new Vec3i(11,-1,0), //第十一行
                new Vec3i(12,-1,24),
                new Vec3i(12,-1,20),
                new Vec3i(12,-1,2), //第十二行
                new Vec3i(13,-1,24),
                new Vec3i(13,-1,22),
                new Vec3i(13,-1,20),
                new Vec3i(13,-1,4),
                new Vec3i(13,-1,2),
                new Vec3i(13,-1,0), //第十三行
                new Vec3i(14,-1,24),
                new Vec3i(14,-1,22),
                new Vec3i(14,-1,20),
                new Vec3i(14,-1,4),
                new Vec3i(14,-1,2),
                new Vec3i(14,-1,0), //十四行
                new Vec3i(17,-1,20),
                new Vec3i(17,-1,4), //十七行
                new Vec3i(18,-1,20),
                new Vec3i(18,-1,19),
                new Vec3i(18,-1,5),
                new Vec3i(18,-1,4), //十八行
                new Vec3i(19,-1,22),
                new Vec3i(19,-1,19),
                new Vec3i(19,-1,18),
                new Vec3i(19,-1,6),
                new Vec3i(19,-1,5),
                new Vec3i(19,-1,2), //十九行
                new Vec3i(20,-1,22),
                new Vec3i(20,-1,21),
                new Vec3i(20,-1,18),
                new Vec3i(20,-1,17),
                ...
                new Vec3i(20,-1,6),
                new Vec3i(20,-1,3),
                new Vec3i(20,-1,2), //二十行
                new Vec3i(21,-1,24),
                new Vec3i(21,-1,21),
                new Vec3i(21,-1,20),
                new Vec3i(21,-1,4),
                new Vec3i(21,-1,0), //二十一行
                new Vec3i(22,-1,24),
                new Vec3i(22,-1,23),
                new Vec3i(22,-1,20),
                new Vec3i(22,-1,19),
                ...
                new Vec3i(22,-1,4),
                new Vec3i(22,-1,1),
                new Vec3i(22,-1,0), //二十二行
                new Vec3i(23,-1,22),
                new Vec3i(23,-1,2), //二十三行
                new Vec3i(24,-1,22),
                new Vec3i(24,-1,21),
                new Vec3i(24,-1,14),
                new Vec3i(24,-1,13),
                ...
                new Vec3i(24,-1,10),
                new Vec3i(24,-1,3),
                new Vec3i(24,-1,2)  //二十四行

        );
        List<Vec3i> altarBlocks = List.of(
                new Vec3i(12,0,17), //离 火
                new Vec3i(8,0,16),  //坤 地
                new Vec3i(7,0,12),  //兑 泽（金）
                new Vec3i(8,0,8),   //乾 天
                new Vec3i(12,0,7),  //坎 水
                new Vec3i(16,0,8),  //艮 山
                new Vec3i(17,0,12), //震 雷
                new Vec3i(16,0,16)  //巽 风
        );
