...
public class ChargeDamageTypes {
    public static ResourceKey<DamageType> register(String name) {
        return ResourceKey.create(Registries.DAMAGE_TYPE, new ResourceLocation(ChargeModItemRegistry.MODID, name));
    }

    public static final ResourceKey<DamageType> DAO_HEAVY = register("dao_heavy");
    public static final ResourceKey<DamageType> DAO_REAL = register("dao_real");
...
//    public static final ResourceKey<DamageType> POISON_CLOUD = register("poison_cloud");
    ...
    public static void bootstrap(BootstapContext<DamageType> context) {
        context.register(DAO_HEAVY, new DamageType(DAO_HEAVY.location().getPath(), DamageScaling.WHEN_CAUSED_BY_LIVING_NON_PLAYER, 0f));
        context.register(DAO_REAL, new DamageType(DAO_REAL.location().getPath(), DamageScaling.WHEN_CAUSED_BY_LIVING_NON_PLAYER, 0f));
