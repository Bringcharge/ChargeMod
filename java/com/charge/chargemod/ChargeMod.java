...
public class ChargeMod
{
    ...
    public static final RegistryObject<Block> EXAMPLE_BLOCK = BLOCKS.register("charge_block", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.STONE)));
    // Creates a new BlockItem with the id "examplemod:example_block", combining the namespace and path
    public static final RegistryObject<Item> EXAMPLE_BLOCK_ITEM = ITEMS.register("charge_block", () -> new BlockItem(EXAMPLE_BLOCK.get(), new Item.Properties()));
